...
function getDepartmentDisplayName(contextCode) {
  const nameMap = {
    ...
    'FIN': 'Department of Finance Canada (FIN) — shared with the Canada Tariff Finder (TARIFF-TARIF)',
