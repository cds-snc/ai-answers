...
import dbUsersSecretsHandler from '../api/db/db-users-secrets.js';
...
import dbMetricsDashboardHandler from '../api/db/db-metrics-dashboard.js';
...
app.get('/api/db/db-metrics-dashboard', dbMetricsDashboardHandler);
...
app.post('/api/db/db-users-secrets', dbUsersSecretsHandler);
