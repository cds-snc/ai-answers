...
import settingClearSearchCacheHandler from '../api/setting/setting-clear-search-cache.js';
...
app.post('/api/setting/setting-clear-search-cache', settingClearSearchCacheHandler);
