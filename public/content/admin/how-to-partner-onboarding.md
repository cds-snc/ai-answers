...
Use real user questions in the user's own words, including typos and awkward grammar. Don't use questions of 1 or 2 words (they will be rejected).
...
5. Fix what the evaluations turn up, including fixing web content problems and tuning your scenario.
