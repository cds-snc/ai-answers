...
export default function handler(req, res) {
	// Require authentication and either partner or admin role to delete chats
	return withProtection(deleteChatHandler, authMiddleware, partnerOrAdminMiddleware)(req, res);
}
