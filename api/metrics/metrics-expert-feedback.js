...
async function getExpertMetrics(req, res) {
    ...
    try {
        ...
        const result = await Chat.aggregate(buildExpertFeedbackPipeline(dateFilter, extraFilterConditions, departmentFilter, answerTypeFilter, partnerEvalFilter, aiEvalFilter));
