    ...
    async analyze(input) {
        ...
        if (!referenceAnswer) {
            return {
                ...
                confidence: 1,
                explanation: 'No reference answer was provided; this run can be used as the reference for a future comparison.',
                changedFacts: [],
                referenceOnlyFacts: [],
                currentOnlyFacts: [],
                ignoredDifferences: []
        ...
        if (!answer) {
            return {
                ...
                confidence: 1,
                comparisonExplanation: 'Current answer is empty while the reference has an answer.',
                changedFacts: [{
                    type: 'answer-type',
        ...
        if (answer === referenceAnswer && !datasetReferenceAnswer) {
            return {
                ...
                differenceFound: false,
                confidence: 1,
                comparisonExplanation: 'Answers are identical after normalization.',
                changedFacts: [],
                referenceOnlyFacts: [],
                currentOnlyFacts: [],
                ignoredDifferences: []
