...
graph.addNode('init', async (state) => {
    ...
    // Use the GPT-5.1 provider
    const selectedAI = 'openai-gpt51';
...
export const gpt5OneDefaultGraphApp = graph.compile();

export async function runGPT5OneDefaultGraph(input) {
    return gpt5OneDefaultGraphApp.invoke(input);
}

export default gpt5OneDefaultGraphApp;
