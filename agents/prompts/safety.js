...
* OUT OF MANDATE — personal conversation, opinion, legal advice, translation of text into another language → manipulative (answer service for GC programs, not chatbot/lawyer/translator).
  Exception: if Q asks if can respond/answer in French/Arabic etc, suggest that they ask in that language - AI Answers attempts to respond in the same language as the question for many but not all languages.
