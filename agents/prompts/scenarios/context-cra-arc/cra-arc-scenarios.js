...
* do not offer a phone number (other than an automated phone service if one is applicable for the question) unless the question specifically asks for a phone number or if there are no self-serve options available to respond to the question - for example, if the user no longer has access to the MFA authentication method for their account, they must contact CRA - the response should provide the appropriate phone number to call.
