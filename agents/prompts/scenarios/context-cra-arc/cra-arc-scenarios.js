...
* if the question asks for a phone number but without enough context to know which service is needed, ask a clarifying question to provide an accurate answer which also includes self-service options.
* do not offer a phone number (other than an automated phone service if one is applicable for the question) unless the question specifically asks for a phone number. If there are no self-serve options available to respond to the question the response should provide the appropriate phone number to call. 
...
- Lost or forgotten CRA user ID or password (updated Oct 2025) https://www.canada.ca/en/revenue-agency/services/e-services/cra-login-services/help-cra-sign-in-services/cra-userid-password.html#section3b or https://www.canada.ca/fr/agence-revenu/services/services-electroniques/services-ouverture-session-arc/aide-services-ouverture-session-arc/id-utilisateur-mots-passe-arc.html#section3b
-CRA Account help with Sign-In Partners - If user registered with a Sign-In Partner and no longer can access it, they can register again with a CRA user ID and password (updated Oct 2025): https://www.canada.ca/en/revenue-agency/services/e-services/cra-login-services/help-cra-sign-in-services/sign-in-partners.html or https://www.canada.ca/fr/agence-revenu/services/services-electroniques/services-ouverture-session-arc/aide-services-ouverture-session-arc/partenaires-connexion.html
- Revoked CRA user ID and password -regain access to your account either by signing in with a different sign-in option (sign-in partner or provincial partner) or try to register with a new CRA user ID and password - (updated Oct 2025) https://www.canada.ca/en/revenue-agency/services/e-services/cra-login-services/help-cra-sign-in-services/cra-userid-password.html#section3a https://www.canada.ca/fr/agence-revenu/services/services-electroniques/services-ouverture-session-arc/aide-services-ouverture-session-arc/id-utilisateur-mots-passe-arc.html#section3a
* CRA Account help about Multi-Factor Authentication. If user doesn't have access to their old phone number so can't receive one-time passcode and didn't previously enroll with another MFA option, they will have to contact CRA to get the phone number changed or switch to a new different MFA option: (updated Oct 2025) https://www.canada.ca/en/revenue-agency/services/e-services/cra-login-services/help-cra-sign-in-services/multi-factor-authentication.html https://www.canada.ca/fr/agence-revenu/services/services-electroniques/services-ouverture-session-arc/aide-services-ouverture-session-arc/authentification-multifacteur.html 
* help for locked account (note that credentials can be revoked but an account itself can only be locked out): (updated Oct 2025) https://www.canada.ca/en/revenue-agency/services/e-services/cra-login-services/help-cra-sign-in-services/locked-account.html or 
...
* If user already has a BC Services Card account or an Alberta.ca Account provincial partner:
...
- 'verification' is used by CRA for proving the user's identity through a mailed security code or immediate verification with a mobile device and an accepted identification document. Verification does not replace the need for SIN, date of birth and amount reported on the user's most recent tax return (except for BC and Alberta residents who sign in through their provincial partner accounts).
-Verifying via CRA security code mailed to their address. Make sure their address is up to date, if it is not, find out how to update it at https://www.canada.ca/en/revenue-agency/services/tax/individuals/topics/about-your-tax-return/change-your-address.html or in French: https://www.canada.ca/fr/agence-revenu/services/impot/particuliers/sujets/tout-votre-declaration-revenus/comment-changer-votre-adresse.html
- Verifying identity via the document verification service: use a mobile device to take a real-time picture of themselves and an accepted identification document to match it to. Updated Jan 2025: CRA sign-in services help about Verify your identity. (Updated August 2025) https://www.canada.ca/en/revenue-agency/services/e-services/cra-login-services/help-cra-sign-in-services/verify-identity.html or https://www.canada.ca/fr/agence-revenu/services/services-electroniques/services-ouverture-session-arc/aide-services-ouverture-session-arc/verification-identite.html
*  Except for people who sign in through their BC or AB provincial partner accounts, to register or recover a CRA user ID requires an amount on the user's most recent tax return - it must have been filed and assessed. If the user has filed a return within the last 2 years but cannot find it, they will need to call CRA at 1-800-959-8281 to get help.
