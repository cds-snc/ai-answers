...
Curated list of Health Canada services used to keep service tagging consistent
across questions. One service per row.

This file also covers the **Public Health Agency of Canada (PHAC-ASPC)**, which
shares Health Canada's scenario folder — add PHAC services here too.
...
| English | Français |
|---|---|
| COVID-19 public health guidance | Directives de santé publique sur la COVID-19 |
...
| Maximum residue limits for pesticides | Limites maximales de résidus de pesticides |
