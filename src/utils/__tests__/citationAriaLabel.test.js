...
describe('buildAriaLabel', () => {
  describe('Tier 1 — readable slug', () => {
    ...
    it('derives label from last readable slug (fr)', () => {
      ...
      ).toBe("Assurance emploi — canada point CA (s'ouvre dans un nouvel onglet) https://www.canada.ca/fr/services/prestations/ae/assurance-emploi.html");
    });
    ...
    it('resolves bilingual slug daily-quotidien to Le Quotidien in French without dept prefix', () => {
      ...
      ).toBe("Le Quotidien — statcan point GC point CA (s'ouvre dans un nouvel onglet) https://www150.statcan.gc.ca/n1/daily-quotidien/250429/dq250429b-fra.htm");
    });
    ...
    it('resolves bilingual slug dai-quo to Le Quotidien in French', () => {
      ...
      ).toBe("Le Quotidien — statcan point GC point CA (s'ouvre dans un nouvel onglet) https://www150.statcan.gc.ca/n1/dai-quo/index-fra.htm");
    });
    ...
    it('decodes percent-encoded path characters (C3)', () => {
      ...
      ).toBe("Bénéfices emploi — canada point CA (s'ouvre dans un nouvel onglet) https://canada.ca/fr/services/b%C3%A9n%C3%A9fices-emploi.html");
    });
  });
  ...
  describe('Tier 3 — unregistered GC domain', () => {
    ...
    it('prefixes Government of Canada for unregistered gc.ca domain (fr)', () => {
      ...
      ).toBe("Gouvernement du Canada — voyage point GC point CA (s'ouvre dans un nouvel onglet) https://voyage.gc.ca/fr/98765");
    });
