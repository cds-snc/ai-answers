...
export const MOCK_METRICS = {
  ...
  byDepartment: {
    CRA:   { total: 89,  expertScored: { total: 34 } },
    IRCC:  { total: 67,  expertScored: { total: 28 } },
    ESDC:  { total: 54,  expertScored: { total: 18 } },
    HC:    { total: 43,  expertScored: { total: 9  } },
    DFO:   { total: 38,  expertScored: { total: 0  } },
    NRCan: { total: 31,  expertScored: { total: 0  } },
