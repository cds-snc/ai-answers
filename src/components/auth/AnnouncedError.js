...
// Focus is what reads this out; it's deliberately not also role="alert" (that was
// a double read — see status-and-error-messaging.md).
...
const AnnouncedError = ({ id, message, errorCount, inputRef, className = 'form-error-message font-size-text-sm-nr mrgn-bttm-20' }) => (
  <div key={errorCount} id={id} className={className} tabIndex={-1} ref={inputRef}>
