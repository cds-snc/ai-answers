...
// any page might need an inline "still working" message), this is specific
// to dashboards with a filter-driven fetch that blocks the whole page while
// filtered results reload. Narrow enough to earn its own file rather than a
// prop on a component everything else uses too.
