...
const SUPPORTED_DEPARTMENTS = ['AAFC-AAC', 'BAC-LAC', 'CBSA-ASFC', 'CEO-BEC', 'CDS-SNC', 'CRA-ARC', 'DND-MDN', 'ECCC', 'EDSC-ESDC', 'FIN', 'HC-SC', 'IRCC', 'ISED-ISDE', 'JUS', 'NRCan-RNCan', 'PSPC-SPAC', 'SAC-ISC', 'StatCan', 'TC', 'TBS-SCT', 'VAC-ACC'];
